...
class FPNOBJCCountryCodeManager {
    ...
    func getCountryCode(for key: FPNOBJCCountryKey) -> String? {
        lock.lock()
        defer { lock.unlock() }
        return countryCode[key]
    }
    
    func setCountryCode(for key: FPNOBJCCountryKey, value: String) {
        lock.lock()
        defer { lock.unlock() }
...
/*
 public actor FPNOBJCCountryCodeManager {
     ...
     public func getCountryCode(for key: FPNOBJCCountryKey) -> String? {
         return countryCode[key]
     }
     
     public func setCountryCode(for key: FPNOBJCCountryKey, to value: String) {
         countryCode[key] = value
     }
 }
*/
